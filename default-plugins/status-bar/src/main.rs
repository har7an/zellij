    ...
    match palette.source {
        PaletteSource::Default => ColoredElements {
            selected: SegmentStyle {
                prefix_separator: style!(palette.green).bold(),
                ...
                suffix_separator: style!(palette.green).bold(),
            },
            unselected: SegmentStyle {
                prefix_separator: style!(palette.fg),
                ...
                suffix_separator: style!(palette.fg),
            },
            unselected_alternate: SegmentStyle {
                prefix_separator: style!(alternate_background_color),
                ...
                suffix_separator: style!(alternate_background_color),
            },
        ...
        PaletteSource::Xresources => ColoredElements {
            ...
            superkey_suffix_separator: style!(palette.fg),
        },
    }
}
